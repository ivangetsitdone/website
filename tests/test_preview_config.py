...
class PreviewConfigTests(unittest.TestCase):
    ...
    def test_host_owned_deployer_pins_preview_ref_and_trusted_compose(self):
        ...
        self.assertIn("sshd -T -C user=root", production)
        self.assertIn("authorizedkeysfile", production)
        self.assertIn("sed -i '/github-preview@ivangetsitdone$/d'", production)
        ...
        self.assertIn("PREVIEW_DEPLOY_USER || 'root'", preview_workflow)
