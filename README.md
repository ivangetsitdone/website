...
- `/before-after`: six projects labelled “Project / 01…”: side-yard clearing, garden steps, the shower remodel, sidewalk clearing, parking-lot restriping and a siding repair. The owner confirmed the shower project's two **before** photos and the three before/after pairs (sidewalk, parking lot, siding); the shower's tile photos are still explicitly **in progress**, not finished. The first two groupings and the remaining captions still need owner review; “Detail” does not claim a completed job.
